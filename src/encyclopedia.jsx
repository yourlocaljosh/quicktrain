    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6 text-center">Encyclopedia</h1>
          <p className="text-gray-600 text-center">Our favorite exercises for every single muscle group.</p>
        </div>
      </main>
    </div>
  );
